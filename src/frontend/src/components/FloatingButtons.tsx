export default function FloatingButtons() {
  return (
    <>
      ...
      >
        {/* Pulsing ring */}
        <span className="absolute w-14 h-14 rounded-full bg-green-400/50 animate-ping" />
        {/* WhatsApp icon */}
        <svg
          viewBox="0 0 24 24"
          fill="white"
      ...
      <a
        ...
        className="fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-200"
        style={{
          background:
